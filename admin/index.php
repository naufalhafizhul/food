        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="index.php?halaman=kategori"><i class="fa fa-cube fa-2x"></i> Kategori</a></li>
                    <li><a href="index.php?halaman=produk"><i class="fa fa-tags fa-2x"></i> Produk</a></li>
                    <li><a href="index.php?halaman=pembelian"><i class="fa fa-shopping-cart fa-2x"></i> Pemesanan Pelanggan</a></li>
